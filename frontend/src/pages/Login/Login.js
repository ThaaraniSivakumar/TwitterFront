...
<form onSubmit={handleSubmit}>
    <input style={{marginTop:'20px'}} type="email" className='email' placeholder='Email address' onChange={(e)=>setEmail(e.target.value)}/>
    <input type="password" style={{marginTop:'20px'}} className='password' placeholder='Password' onChange={(e)=>setPassword(e.target.value)}/>
